...
background-position: 90px 185px, 167px 320px, 244px 185px, 321px 320px, 244px 455px, 167px 50px
background-image: url(img/rtweet-logo.svg), url(img/hexagon-logo.png), url(img/textfeatures-logo.png), url(img/tfse-logo.png), url(img/botrnot-logo.png), url(img/chr-logo.png)
class: right
...
+ Twitter and the 2016 election
   - Dissertation followed user networks of partisan groups
   - Side effect of data collection: **{[rtweet](https://github.com/mkearney/rtweet)}**

+ Public concerns about big data and manipulative "bot" accounts
   - What Cambridge Analytica represents
